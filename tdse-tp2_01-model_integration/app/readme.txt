 ...
 Project for STM32 Project (STM32CubeIDE Version: 1.17.0)
  ...
  app.c (app.h)
   ...
   Cyclic Executive (Update by Time Code, period = 1mS)
    ...
    task_printer.c (task_printer.h, task_printer_attribute.h) 
     Non-Blocking Code (Update by Time Code, period = 1mS) -> Printer Modeling

      task_printer_interface.c (task_printer_interface.h)
       Non-Blocking Code
